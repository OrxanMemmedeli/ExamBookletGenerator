...
{
    public const string NotEmptyAndNotNull = "{0} sahəsi boş ola bilməz";
    public const string MinimumLength = "{0} sahəsi ən az {1} simvol ola bilər";
    public const string MaximumLength = "{0} sahəsi ən çox {1} simvol ola bilər";
    ...
    public const string GreaterThanOrEqualTo = "{0} sahəsi {1} və ya daha böyük dəyər olmalıdır";
