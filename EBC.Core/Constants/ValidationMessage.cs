...
public static class ValidationMessage
{
    ...
    public const string GreaterThanOrEqualTo = "Bu sahə {0} və ya daha böyük dəyər olmalıdır";
    ...
    public const string NotCanContainsComma = "Vergül simvolu yazıla bilməz";
