    ...
    where TEntity : class
{
    ...
    //CompiledQuery Methods
    IEnumerable<TEntity> GetAllCompiled(bool noTracking = true);
    IEnumerable<TEntity> GetAllCompiled(Expression<Func<TEntity, bool>> predicate, bool noTracking = true, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy = null, params Expression<Func<TEntity, object>>[] includes);
